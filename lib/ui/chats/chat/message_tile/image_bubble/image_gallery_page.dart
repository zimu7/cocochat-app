...
import 'package:cocochat_app/ui/chats/chat/message_tile/image_bubble/image_share_sheet.dart';
import 'package:cocochat_app/ui/chats/chat/message_tile/image_bubble/single_image_item.dart';
import 'package:cocochat_app/ui/chats/chat/message_tile/image_bubble/single_image_page.dart';

class ImageGalleryPage extends StatefulWidget {
  const ImageGalleryPage({super.key, required this.data});
...
// with LandscapeStatefulModeMixin<ImageGalleryPage>
{
  ...
  void _saveImage() async {
    ...
    try {
      ...
      final result = await SaverGallery.saveImage(imageBytes, fileName: name, skipIfExists: false);
