...
import 'package:cocochat_app/api/models/saved/saved_response.dart';
import 'package:cocochat_app/app.dart';
import 'package:cocochat_app/app_consts.dart';
import 'package:cocochat_app/dao/init_dao/saved.dart';
...
import 'package:cocochat_app/ui/chats/chat/message_tile/saved_bubble.dart';
import 'package:cocochat_app/ui/widgets/empty_content_placeholder.dart';

class SavedItemPage extends StatefulWidget {
  final int? gid;
  final int? uid;

  SavedItemPage({super.key, this.gid, this.uid}) {
