...
import 'package:cocochat_app/ui/chats/chat/message_tile/archive_bubble.dart';
...
import 'package:cocochat_app/ui/chats/chat/message_tile/msg_tile_frame.dart';
...
class PinnedMsgTile extends StatelessWidget {
  ...
  const PinnedMsgTile(
      {super.key, required this.gid, required this.msg, required this.userInfoM});
