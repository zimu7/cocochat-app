...
import 'package:cocochat_app/ui/widgets/banner_button.dart';
import 'package:cocochat_app/ui/widgets/full_width_textfield.dart';
...
class MagiclinkLogin extends StatefulWidget {
  ...
  const MagiclinkLogin({super.key, required this.chatServer});
