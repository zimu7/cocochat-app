...
import 'package:cocochat_app/api/lib/resource_api.dart';
...
import 'package:cocochat_app/api/models/msg/chat_msg.dart';
import 'package:cocochat_app/api/models/msg/msg_archive/pinned_msg.dart';
import 'package:cocochat_app/api/models/resource/open_graphic_image.dart';
import 'package:cocochat_app/api/models/user/user_info.dart';
import 'package:cocochat_app/api/models/user/user_info_update.dart';
import 'package:cocochat_app/app.dart';
import 'package:cocochat_app/app_consts.dart';
import 'package:cocochat_app/dao/init_dao/archive.dart';
...
import 'package:cocochat_app/dao/init_dao/open_graphic_thumbnail.dart';
import 'package:cocochat_app/dao/init_dao/properties_models/user_settings/user_settings.dart';
import 'package:cocochat_app/dao/init_dao/reaction.dart';
import 'package:cocochat_app/dao/init_dao/user_info.dart';
import 'package:cocochat_app/dao/init_dao/user_settings.dart';
import 'package:cocochat_app/dao/org_dao/properties_models/chat_server_properties.dart';
...
import 'package:cocochat_app/models/local_kits.dart';
...
import 'package:cocochat_app/services/sse/server_event_consts.dart';
import 'package:cocochat_app/services/sse/server_event_queue.dart';
    ...
    return await OpenGraphicThumbnailDao()
      ...
      if (value != null) {
        for (var item in value) {
          ...
          map['siteName'] = item.siteName;
          map['title'] = item.title;
          map['desc'] = item.description;
          map['url'] = item.url;
          list.add(map);
        }
        return list;
