...
class FileHandler {
  ...
  Future<File?> getLocalArchiveFile(String archiveId, int attachmentId,
    ...
    if (await archiveFileExists(archiveId, attachmentId, fileName0)) {
      return readArchiveFile(archiveId, attachmentId, fileName0);
    }
    return null;
  }
    ...
    try {
      ...
      if (res.statusCode == 200 && res.data != null && res.data!.isNotEmpty) {
        return await saveArchiveFile(
            res.data!, archiveId, attachmentId, fileName0);
      }
    } catch (e) {
      App.logger.severe(e);
    }
  ...
  Future<File?> getLocalSavedItemsFile(
    ...
    String fileName0 =
        (fileName != null && fileName.isNotEmpty) ? fileName : "avatar.jpg";
    if (await savedItemsFileExists(archiveId, attachmentId, fileName0)) {
      return readSavedItemsFile(archiveId, attachmentId, fileName0);
    }
    return null;
  }
