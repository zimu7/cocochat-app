...
import 'package:cocochat_app/services/db.dart' as coco_db;
  ...
  Future<PageData<T>> paginate(PageMeta pageMeta,
    ...
    // request is needed to fetch the entry count.
    {
      ...
      if (count == null) {
        ...
        throw StateError(
            'COUNT(*) = null in paginate, table: ${meta.tableName}');
      } else {
