...
import 'package:cocochat_app/api/models/msg/msg_reaction.dart';
...
import 'package:cocochat_app/dao/dao.dart';
...
class ChatMsgM extends Equatable with M {
  ...
  // int _edited = 0;
  // MsgStatus: fail, success, sending
  String statusStr = MsgStatus.success.name;
  ...
  /// Check whether a message is of type cocochat/file
  ///
  ...
  /// text/plain, text/markdown, cocochat/file, cocochat/archive
  /// in msgNormal.detail
